...
class MovimientoLoteController {
  ...
  async getByTipoMovimiento(req: Request, res: Response) {
    try {
      ...
      const movimientos = await movimientoLoteService.getByTipoMovimiento(
        tipo_movimiento
      );
      return sendSuccess(res, movimientos);
    } catch (error: any) {
  ...
  async getByUsuarioId(req: Request, res: Response) {
    try {
      ...
      const movimientos = await movimientoLoteService.getByUsuarioId(
        usuario_id
      );
      return sendSuccess(res, movimientos);
    } catch (error: any) {
  ...
  async getUltimosMovimientos(req: Request, res: Response) {
    try {
      ...
      const movimientos = await movimientoLoteService.getUltimosMovimientos(
        limitNumero
      );
      return sendSuccess(res, movimientos);
    } catch (error: any) {
  ...
  async registrarMovimiento(req: Request, res: Response) {
    try {
      const { lote_id, tipo_movimiento, cantidad, cantidad_anterior, nota } =
        req.body;
